  ...
  return (
    <section className="bg-[#f6f6f6] py-12 sm:py-16 lg:py-20" data-aos="fade-up" data-aos-delay="100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Top Row */}
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-10 lg:mb-14 gap-6">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              Our Expertise Across <br className="hidden sm:block" />
              Diverse{" "}
              <span className="text-orange-500">Working Areas</span>
            </h2>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <Link 
              href="/Location"
            className="flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-orange-400 to-orange-500 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl text-sm sm:text-base font-medium shadow-lg hover:scale-105 transition">
              View All Locations
          ...
          {locations.map((item, index) => (
            ...
            >
              ...
              <img
                src={item.image}
                alt={item.name}
                className="w-full h-[260px] sm:h-[280px] md:h-[300px] lg:h-[320px] object-cover group-hover:scale-105 transition duration-500"
              />
