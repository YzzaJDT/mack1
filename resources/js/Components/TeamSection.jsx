    ...
    <section className="bg-[#f9fafb] py-16 px-5 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div>
            {/* <span className="inline-flex items-center gap-2 text-xs bg-gray-200 text-gray-600 px-3 py-1 rounded-full">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mt-4">
              ...
              {/* <span className="text-orange-500">Property</span> Deal */}
            </h2>
          </div>
        ...
        >
          {team.map((member, index) => (
            <div
              key={index}
              className="min-w-[260px] sm:min-w-[300px] lg:min-w-[320px] h-[420px] relative rounded-2xl overflow-hidden group"
            >
